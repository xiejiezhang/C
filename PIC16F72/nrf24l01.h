...
#define TX_ADDR_WIDTH    5   // 5 bytes TX address width
#define RX_ADDR_WIDTH    5   // 5 bytes RX address width
...
extern uchar const TX_ADDRESS[TX_ADDR_WIDTH];//TX address
extern uchar const RX_ADDRESS[RX_ADDR_WIDTH];//;RX address
